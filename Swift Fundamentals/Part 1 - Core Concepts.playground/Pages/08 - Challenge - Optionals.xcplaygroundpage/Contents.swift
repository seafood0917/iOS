...
// TODO: Write solution here
let parseInt = Int("10")
// Because if the value inside can be not convertable such as Int("Hey")
/*:
 ## Challenge 3
...
// TODO: Write solution here
let newParseInt = Int("cat")
// nil, becuase compiler does not know what int value to be converted.
