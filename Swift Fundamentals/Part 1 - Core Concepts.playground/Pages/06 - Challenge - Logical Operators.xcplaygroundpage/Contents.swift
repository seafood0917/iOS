...
/*:
 ...
 Use that constant to create an `if-else` statement to print out `"Teenager"` if the value of `myAge` is greater than or equal to 13 but less than or equal to 19, and to print out `"Not a teenager"` if the value is outside that range.
 */
...
// TODO: Write solution here
let teenagerName = myAge >= 13 && myAge <= 19 ? "Daesik Choi" : "Not Me!"
print(teenagerName)
