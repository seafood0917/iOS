...
// This object will be in charge of handling the various states of the photo capture process as stated by the AVCapturePhotoCaptureDelegate protocol's methods.
...
class PhotoCaptureProcessor: NSObject {
    ...
    // Init takes multiple closures to be called in each step of the photo capture process
...
extension PhotoCaptureProcessor: AVCapturePhotoCaptureDelegate {
    // This extension adopts AVCapturePhotoCaptureDelegate protocol methos.
    ...
    // MARK: Saves caputre to photo library
